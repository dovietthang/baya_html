...
(function (require) {
    ...
    (function () {
        var config = {
            map: { "*": { escaper: "Magento_Security/js/escaper" } },
        };
        require.config(config);
    })();
    (function () {
    ...
    (function () {
        var config = {
            ...
            paths: {
                ...
                cardinaljs:
                    "https://songbird.cardinalcommerce.com/edge/v1/songbird",
            },
        };
        require.config(config);
    })();
            ...
            config: {
                mixins: {
                    "Magento_Checkout/js/model/new-customer-address": {
                        "Amasty_Checkout/js/model/new-customer-address-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/action/get-payment-information": {
                        "Amasty_Checkout/js/action/get-payment-information-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/view/payment/list": {
                        "Amasty_Checkout/js/view/payment/list":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/view/summary/abstract-total": {
                        "Amasty_Checkout/js/view/summary/abstract-total":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/model/step-navigator": {
                        "Amasty_Checkout/js/model/step-navigator-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Paypal/js/action/set-payment-method": {
                        "Amasty_Checkout/js/action/set-payment-method-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_CheckoutAgreements/js/model/agreements-assigner": {
                        "Amasty_Checkout/js/model/agreements-assigner-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/view/summary": {
                        "Amasty_Checkout/js/view/summary-mixin":
                            amasty_mixin_enabled,
                    },
                    ...
                    "Magento_Checkout/js/view/summary/cart-items": {
                        "Amasty_Checkout/js/view/summary/cart-items-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/model/payment/additional-validators": {
                        "Amasty_Checkout/js/model/payment-validators/additional-validators-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/model/checkout-data-resolver": {
                    ...
                    "Magento_Checkout/js/model/shipping-rates-validator": {
                        "Amasty_Checkout/js/model/shipping-rates-validator-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/action/set-shipping-information": {
                        "Amasty_Checkout/js/action/set-shipping-information-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/model/full-screen-loader": {
                        "Amasty_Checkout/js/model/full-screen-loader-mixin":
                            amasty_mixin_enabled,
                    },
                    ...
                    "Magento_Checkout/js/view/payment": {
                        "Amasty_Checkout/js/view/payment-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/model/payment-service": {
                        "Amasty_Checkout/js/model/payment-service-mixin":
                            amasty_mixin_enabled,
                    },
                    "Magento_Checkout/js/model/address-converter": {
                        "Amasty_Checkout/js/model/address-converter-mixin":
                            amasty_mixin_enabled,
                    },
        ...
        if (amasty_mixin_enabled) {
            config["map"]["*"] = {
                checkoutCollapsibleSteps:
                    "Amasty_Checkout/js/view/checkout/design/collapsible-steps",
    ...
    (function () {
        var config = {
            ...
            map: { "*": { configurable: "Amasty_Promo/js/type/configurable" } },
        };
        require.config(config);
    })();
    (function () {
    ...
    (function () {
        var config = {
            map: {
                "*": {
                    directoryFieldUpdater: "Cnf_OrdersList/js/field-updater",
                },
            },
        };
        require.config(config);
        ...
        var config = {
            paths: {
                ...
                internationalTelephoneInput:
                    "Dotdigitalgroup_Sms/js/internationalTelephoneInput",
            },
            shim: {
                intlTelInput: { deps: ["jquery", "knockout"] },
                internationalTelephoneInput: {
        ...
        var config = {
            paths: {
                ...
                "mageplaza/core/owl.carousel":
                    "Mageplaza_Core/js/owl.carousel.min",
    ...
    (function () {
        var config = {
            ...
            shim: {
                "magepow/easing": { deps: ["jquery"] },
                "magepow/slick": { deps: ["jquery"] },
            },
        };
        require.config(config);
    })();
    (function () {
        var config = {
            paths: {
                "magepow/lazyload":
                    "Magepow_SpeedOptimizer/js/plugins/lazyload.min",
            },
            shim: { "magepow/lazyload": { deps: ["jquery"] } },
        };
        require.config(config);
    })();
    (function () {
        var config = {
            map: { "*": { facebookpixel: "Mlx_FacebookPixel/js/js" } },
        };
        require.config(config);
    })();
    (function () {
    ...
    (function () {
        var config = {
            map: {
                "*": {
                    onoffaccordion: "Mlx_LayeredNavigation/js/accordion",
                    layered: "Mlx_LayeredNavigation/js/js",
                },
            },
        };
        require.config(config);
    ...
    (function () {
        var config = {
            map: {
                "*": {
                    "Magento_Customer/js/customer-data":
                        "Overdose_Improve/js/customer-data",
                },
            },
        };
        require.config(config);
    ...
    (function () {
        var config = {
            map: {
                "*": {
                    braintree:
                        "https://js.braintreegateway.com/web/3.79.1/js/client.min.js",
                },
            },
            paths: {
                braintreePayPalCheckout:
                    "https://js.braintreegateway.com/web/3.79.1/js/paypal-checkout.min",
                braintreeHostedFields:
                    "https://js.braintreegateway.com/web/3.79.1/js/hosted-fields.min",
                braintreeDataCollector:
                    "https://js.braintreegateway.com/web/3.79.1/js/data-collector.min",
                braintreeThreeDSecure:
                    "https://js.braintreegateway.com/web/3.79.1/js/three-d-secure.min",
                braintreeApplePay:
                    "https://js.braintreegateway.com/web/3.79.1/js/apple-pay.min",
                braintreeGooglePay:
                    "https://js.braintreegateway.com/web/3.79.1/js/google-payment.min",
                braintreeVenmo:
                    "https://js.braintreegateway.com/web/3.79.1/js/venmo.min",
                braintreeAch:
                    "https://js.braintreegateway.com/web/3.79.1/js/us-bank-account.min",
                braintreeLpm:
                    "https://js.braintreegateway.com/web/3.79.1/js/local-payment.min",
    ...
    (function () {
        var config = {
            paths: {
                slickCarousel: "js/slick/slick.min",
                jqueryZoom: "js/jquery.zoom.min",
                jqueryLazyload: "js/lazyload.min",
                "owl.carousel": "js/owl.carousel.min",
                jqueryCountDown: "js/jquery.countdown.min",
                flipclock: "js/flipclock.min",
                nprogress: "js/nprogress",
            },
            shim: {
                slickCarousel: { deps: ["jquery"] },
                jqueryZoom: { deps: ["jquery"] },
                jqueryLazyload: { deps: ["jquery"] },
                nprogress: { deps: ["jquery"] },
                "owl.carousel": ["jquery"],
            },
            deps: ["js/global", "js/cms_page", "js/home_slider"],
        };
        require.config(config);
    })();
})(require);
