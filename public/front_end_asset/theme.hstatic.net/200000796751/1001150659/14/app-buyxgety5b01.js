...
(function($){
	...
	buyXgetY = {
		...
		// 					$('#detail-product #buyxgety-program').html("Xin lỗi! Các sản phẩm quà tặng đã hết. Hẹn bạn vào lần khuyến mãi tới nhé!");
		// 				}
		// 				else{
		// 					var is_xy_first = 0;
		...
		// 					}
		// 				}
		// 				$('#detail-product #buyxgety-program').removeClass('d-none');
