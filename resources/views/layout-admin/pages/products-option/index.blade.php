                    ...
                    <div class="d-flex justify-content-between align-items-center mx-0 row">
                        ...
                        <div class="col-12 col-md-3">
                            <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                <label class="d-flex justify-content-end align-items-center">{{ __('Search') }}:<input type="search" class="form-control  w-100" placeholder="" aria-controls="DataTables_Table_0"></label>
                            </div>
                        </div>
                        ...
                        <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1205px;">
                            <thead class="text-center">
                                <tr role="row">
                                    ...
                                    <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 261px;" aria-label="Email: activate to sort column ascending">
                                        {{ __('Số lượng sản phẩm') }}
                                    </th>
                                    <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 93px;" aria-label="Status: activate to sort column ascending">{{__('Status')}}
                                    </th>
                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 68px;" aria-label="Actions">{{ __('Actions') }}
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="odd text-center">
                                    ...
                                    <td>{{ $index->title }}</td>
                                    <?php
                                    $array_of_numbers = explode(",", $index->photo);
                                    ?>
                                    <td>{{ count($array_of_numbers) }}</td>
                                    <td>
                                        @if ($index->status == 0)
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('edit-product-option', [$index->id]) }}" class="item-edit">
