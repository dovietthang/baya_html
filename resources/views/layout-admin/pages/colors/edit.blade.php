        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body app-ecommerce-details">
                    <!-- Form -->
                    <form id="post" action="{{route('update-color')}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="name" class="form-control" placeholder="RED" name="name"
                                        value="{{$color->title}}" />
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <div class="d-flex mb-1 align-items-end">
                                 <div class="w-100">
                                     ...
                                     <input style="border-radius: unset;" type="text" id="value" class="form-control rounded-start"
                                         placeholder="#FFC0CB | pink" name="value" value="{{$color->value}}" />
                                 </div>
                                 <div style="width: 70px;" class="flex-shrink-1">
                                     <input value="{{$color->value}}" style="border-radius: unset; padding: 4px;height: 38.27px;" type="color" id="color" class="form-control cursor-pointer text-uppercase rounded-end" name="color" />
                                 </div>
                                </div>
                             </div>
                            <div class="col-md-6 col-12" id="status-p">
                                <div class="mb-1">
                                    ...
                                    <select class="select2 form-select" name="status" id="status">
                                        <option @if($color->status == 1) selected @endif value="1" >{{__('Active')}}
                                        </option>
                                        <option @if($color->status == 0) selected @endif value="0"
                                            >{{__('Inactive')}}</option>
                                    </select>
                                </div>
                            </div>
