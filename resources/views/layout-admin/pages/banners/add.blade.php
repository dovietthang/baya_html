    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <!-- Form -->
                    <form id="banner" action="{{route('save-banner')}}" enctype="multipart/form-data" method="post"
                        class="" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="Order-by">{{__('Link')}}</label>
                                    <input type="text" id="order-by" class="form-control" name="link"
