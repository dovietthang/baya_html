    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <!-- Form -->
                    <form action="{{route('update-user')}}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="full-name" class="form-control" name="fullname"
                                        placeholder="join" value="{{$user->name}}" />
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="email" id="user-email" class="form-control" name="email"
                                        placeholder="join@gmail.com" value="{{$user->email}}" />
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <select class="form-select" id="user-status" name="status">
                                        <option value="1" @if($user->status == 1) selected @endif >{{__('Activate')}}
                                        </option>
                                        <option value="0" @if($user->status == 0) selected @endif >{{__('Inactive')}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select" id="user-role" name="role">
                                            @if(Auth::user()->role == 0)
                                            <option value="1" @if($user->role == 1) selected @endif>{{__('Admin')}}
                                            </option>
                                            @endif
                                            <option value="3" @if($user->role == 3) selected @endif>{{__('Member')}}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select" id="user-role" disabled>
                                            <option value="0" @if($user->role == 1) selected @endif>{{__('System
                                                Admin')}}</option>
                                            <option value="1" @if($user->role == 1) selected @endif>{{__('Admin')}}
                                            </option>
                                            <option value="2" @if($user->role == 2) selected @endif>{{__('Mod')}}
                                            </option>
                                            <option value="3" @if($user->role == 3) selected @endif>{{__('Member')}}
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-2 in">
                                        ...
                                        <div class="input-group form-password-toggle">
                                            ...
                                            <input placeholder="*******" type="password" id="user-password"
                                        ...
                                        <div class="d-flex flex-column flex-md-row">
                                            ...
                                            <div class="fix-img mt-1 mt-md-0 ms-md-2 mb-md-0">
                                                ...
                                                <img src="{{asset('admin_asset/app-assets/images/empty.png')}}"
                                                    id="blog-feature-image" class="rounded" alt="Blog Featured Image" />
                                                @endif
                                            </div>
                                        </div>
                                    </div>
