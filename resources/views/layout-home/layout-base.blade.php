...
<head>
    ...
    <link rel="preload stylesheet" href="{{asset('/front_end_asset/style-css.css')}}" as="style">
...
<body class="mainBody-theme  template-index" itemscope itemtype="http://schema.org/Website">
    ...
    <div class="mainBody-theme-container mainBody-modalshow     layoutProduct_scroll ">
        <div class="topbar-banner text-center">
            <a href="pages/big-sale.html">
                <picture>
                    <source media="(max-width: 767px)" srcset="{{asset('/front_end_asset/theme.hstatic.net/200000796751/1001150659/14/topbar_img_mb5b01.jpg?v=944')}}" />
                    <source media="(min-width: 768px)" srcset="{{asset('/front_end_asset/theme.hstatic.net/200000796751/1001150659/14/topbar_img5b01.jpg?v=944')}}" />
                    <img class="lazyload" data-src="//theme.hstatic.net/200000796751/1001150659/14/topbar_img.jpg?v=944" src="{{asset('/front_end_asset/theme.hstatic.net/200000796751/1001150659/14/topbar_img5b01.jpg?v=944')}}" alt="banner-topbar" />
                </picture>
            </a>
    ...
    <script type="text/javascript" src="{{asset('/front_end_asset/js/scrip-js.js')}}"></script>
    <script type="text/javascript" src="{{asset('/front_end_asset/hstatic.net/0/0/global/api.jquery.js')}}"></script>
    <script type="text/javascript" src="{{asset('/front_end_asset/js/popper.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('/front_end_asset/bootstrap-4.3.1-dist/js/bootstrap.js')}}" defer></script>
    <script type="text/javascript" src="{{asset('/front_end_asset/theme.hstatic.net/200000796751/1001150659/14/app-buyxgety5b01.js?v=944')}}" defer></script>
