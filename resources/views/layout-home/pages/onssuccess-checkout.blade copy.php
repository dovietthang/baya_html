    ...
    <main id="maincontent" class="page-main">
        ...
        <div class="column main">
            ...
            <div class="checkout-success">
                                ...
                                <table class="data table table-order-items" id="my-orders-table" summary="Items Ordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="order-item-row-1049410">
                                            <td class="col name" data-th="Sản phẩm"><strong class="product name product-item-name">{{$sku->title}}</strong>
                                            ...
                                            <td class="col price" data-th="Giá"> <span class="price-excluding-tax" data-label="Excl. Tax"> <span class="cart-price"> {{number_format($item->price,0,0,'.')}}đ</span>
                                                </span> </td>
                                            <td class="col qty" data-th="Số lượng">
                                                <ul class="items-qty">
                                                    <li class="item"><span class="title">Ordered</span> <span class="content">{{$item->quantity}}</span></li>
                                                </ul>
                                            </td>
                                            <td class="col subtotal" data-th="Tổng tiền"> <span class="price-excluding-tax" data-label="Excl. Tax"> <span class="cart-price"> {{number_format(($item->price * $item->quantity),0,0,'.')}}đ</span> </span> </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <tr class="grand_total">
                                            ...
                                            <td class="amount" data-th="Thành tiền sau chiết khấu">
                                                <strong>{{number_format($order->total,0,0,'.')}}đ</strong>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                ...
                <input type="hidden" id="email" value="a@gmail.com"><input type="hidden" id="phone_number" value="+841212121122">
