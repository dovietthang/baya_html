                                            ...
                                            <div class="site_account_panel_list">
                                                <div id="header-login-panel" class="site_account_panel site_account_default is-selected">
                                                    ...
                                                    <div class="site_account_inner">
                                                        ...
                                                        <form accept-charset='UTF-8' action='https://baya.vn/account/login' id='customer_login' method='post'>
                                                            ...
                                                            <input id='8073e25b06004e6cbb1234e21a4cefbf' name='g-recaptcha-response' type='hidden'><noscript src='../www.google.com/recaptcha/api4d7a.js?render=6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-'></noscript><noscript>grecaptcha.ready(function() {grecaptcha.execute('6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-', {action: 'submit'}).then(function(token) {document.getElementById('8073e25b06004e6cbb1234e21a4cefbf').value = token;});});</noscript>
                                                        </form>

                                                        <div class="site_account_secondary-action">
                                                            <p>Khách hàng mới?
                                                                <a class="link" href="account/register.html">Tạo tài khoản</a>
                                                            </p>
                                                            <p>Quên mật khẩu?
                                                ...
                                                <div id="header-recover-panel" class="site_account_panel site_account_sliding">
                                                    ...
                                                    <div class="site_account_inner">
                                                        ...
                                                        <form accept-charset='UTF-8' action='https://baya.vn/account/recover' method='post'>
                                                            ...
                                                            <input id='2a7aa84706844c79b59fd675ef4e5b2f' name='g-recaptcha-response' type='hidden'><noscript src='../www.google.com/recaptcha/api4d7a.js?render=6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-'></noscript><noscript>grecaptcha.ready(function() {grecaptcha.execute('6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-', {action: 'submit'}).then(function(token) {document.getElementById('2a7aa84706844c79b59fd675ef4e5b2f').value = token;});});</noscript>
                                                        </form>
                                                        <div class="site_account_secondary-action">
